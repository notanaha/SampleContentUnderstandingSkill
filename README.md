...
| `FOUNDRY_API_KEY` | Foundry API key (used for both Azure OpenAI and AI Services operations) |
| `AI_SERVICES_URL` | Azure AI Services endpoint (for Content Understanding) |
